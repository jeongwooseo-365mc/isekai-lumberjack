...
- 지도 던전 버튼을 우하단 암벽산에 맞춰 조금 내렸습니다.
...
GAME_DESIGN_MASTER_v1.0.md   최신 확정 기획
HANDOFF_v1.0.md              구현·빌드 인수인계
BUILD_REPORT_v1.0.md         실제 Windows·Android 빌드 결과
```
