...
GitHub Actions의 한 실행 화면에서 두 플랫폼의 진행 내역과 결과 아티팩트를 함께 확인할 수 있습니다. v1.1.3 Android는 이전 앱과 다른 식별자를 사용해 나란히 설치됩니다. 테스트 APK는 임시 키로 서명되므로 v1.1.3 이후 덮어쓰기 업데이트를 지속하려면 고정 릴리스 키를 설정해야 합니다.
